...
public final class ConstantesBaseDatos {
    ...
    public static final String TABLE_MASCOTA_ID_MASCOTA = "id_mascota";
    ...
    public static final String TABLE_MASCOTA_LIKES_ID               = "id_like";
    ...
    public static final String TABLE_MASCOTA_LIKES_FECHA_CREACION   = "fechacreacion";
}
